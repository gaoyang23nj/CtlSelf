...
+ \frac{ \rho \lambda N }{ \lambda + \rho } \frac{1}{\frac{U_{m}}{N} - \rho} e^{-(\lambda + \rho)t} \\
& + \frac{ \lambda N }{ \lambda + \rho } \left( \frac{\rho}{\frac{U_{m}}{N} - \rho}+1 \right) e^{-(\lambda + \rho)t}.
\end{aligned}
\end{equation}
\end{small}
We can find that $I(t) \rightarrow \frac{ \lambda N }{ \lambda + \rho }$,
...
However, the change rate of $D(t)$ caused by the detection is denoted by
$\frac{D(t)}{N}U(t)$ in the above analysis.
