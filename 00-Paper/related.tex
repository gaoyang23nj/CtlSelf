...
%due to their uncooperative behavior causes vulnerability
...
%The first approach implements the watchdog nodes to analyze the traffic received from their encountered nodes to decide whether they have selfish behavior in message relaying or not~\cite{DBLP:conf/mobicom/MartiGLB00}.
